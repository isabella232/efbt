 ...
 *******************************************************************************/
package org.eclipse.efbt.component.generator.scala.engine;
...
public class GeneratorStandaloneSetup  implements ISetup {
	...
	public void register(Injector injector) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("base_column_structured_data", resourceFactory);	
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("column_structured_data", resourceFactory);
		...
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("base_column_structured_data", serviceProvider);						
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("column_structured_data", serviceProvider);		
