 ...
 *******************************************************************************/
package org.eclipse.efbt.component.platformcalls;
...
import org.eclipse.efbt.almengine.component.common.util.ComparisonUtil;
import org.eclipse.efbt.component.generator.scala.engine.GeneratorConfig;
import org.eclipse.efbt.component.generator.scala.engine.GeneratorStandaloneSetup;
...
public class PlatformCalls {
  ...
  public static void executeCall(PlatformCall call) {
    ...
    if (call instanceof ExecuteAttributeLineageModel) {
        ...
        GeneratorConfig config = new org.eclipse.efbt.component.generator.scala.engine.GeneratorConfig();
